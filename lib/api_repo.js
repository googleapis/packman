  ...
  function callProtoc(protoPath, done) {
    ...
    if (language === 'go') {
      ...
      if (language === 'php') {
        ...
        // (which will be common APIs) without this flag. Other plugins have
        // this behaviour by default
        args.push('--' + language + '_out=skip-imported=true:' + outDir, '-I.');
      } else {
